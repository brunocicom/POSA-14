...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private ArrayList<SimpleSemaphore> mSema;
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	mStrPrint = stringToPrint;
        	mSema = new ArrayList<SimpleSemaphore>(2);
        	mSema.add(FIRST_SEMA, semaphoreOne);
        	mSema.add(SECOND_SEMA, semaphoreTwo);
        ...
        public void run() {
        	...
        	for (int i = 1; i <= mMaxLoopIterations; i++){
        		acquire();
        		System.out.println(mStrPrint + "(" + i +")");
        		release();
        	}
        	mLatch.countDown();
        }
        ...
        private void acquire() {
            // TODO fill in here
        	mSema.get(FIRST_SEMA).acquireUninterruptibly();
        }
